<template>
  <div class="default-main">
          ...
          <div class="welcome suspension">
            ...
            <div class="welcome-text">
              <div class="welcome-title">
                {{ useUser.username + t("utils.comma") + getGreet() }}
              </div>
              ...
              <div v-for="item in 10" class="new-user-item">
                ...
                <div class="new-user-base">
                  <div class="new-user-name">
                    {{ t("dashboard.Good code") }}
                  </div>
                  <div class="new-user-time">
                    {{ t("dashboard.Joined us") }}
                    <span>12{{ t("dashboard.Minutes ago") }}</span>
                  </div>
                </div>
    ...
    <div class="growth-chart">
      <a-row :gutter="20">
        <a-col class="lg-mb-20" :xs="24" :sm="24" :md="24" :lg="12">
          <a-card :title="t('dashboard.Member of the source')">
            <div class="user-source-chart" :ref="chartRefs.set"></div>
          </a-card>
        </a-col>
        <a-col class="lg-mb-20" :xs="24" :sm="24" :md="24" :lg="12">
          <a-card :title="t('dashboard.Member last name')">
...
const initUserSurnameChart = () => {
  const surnamesSourceChart = echarts.init(chartRefs.value[3] as HTMLElement)

  const data = genData(50);

  const option = {
    title: {
      text: t('dashboard.Statistics of the same name'),
      subtext: t('dashboard.A fabrication'),
      left: 'center'
    },
    tooltip: {
      trigger: 'item',
  ...
  surnamesSourceChart.setOption(option)
  state.charts.push(surnamesSourceChart)
}
</script>
